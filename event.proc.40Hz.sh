...
afni_proc.py -subj_id $subj                                           \
        ...
        -regress_stim_labels                                              \
            vs01Hz vs05Hz vs10Hz vs20Hz vs40Hz vigilance    \
        -regress_basis_multi                                              \
        ...
        -regress_opts_3dD                                                 \
            ...
            -glt_label 2 mean_vs01_vs_mean_vs40Hz                             \
            -gltsym 'SYM: 0.333*vs01Hz +0.333*vs05Hz +0.333*vs10Hz'                   \
            -glt_label 3 mean_vs01to10Hz                                              \
            -gltsym 'SYM: 0.5*vs05Hz +0.5*vs10Hz'                                     \
            -glt_label 4 mean_vs05to10Hz                                              \
        -regress_reml_exec                                             \
